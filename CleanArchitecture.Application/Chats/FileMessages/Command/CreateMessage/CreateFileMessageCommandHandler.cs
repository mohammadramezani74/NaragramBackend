...
{
    internal sealed class CreateFileMessageCommandHandler(IApplicationUserManager userManager,
         IApplicationUnitOfWork uow,
         IHttpContextAccessor httpContext,
         IHubContext<NaraHub, IChatHubClient> hubContext) : ICommandHandler<CreateFileMessageCommand, CreateFileMessageResponse>
    {
        ...
        public async Task<OperationResult<CreateFileMessageResponse>> Handle(CreateFileMessageCommand request, CancellationToken cancellationToken)
        {
        ...
        private static async Task<ChatFiles>  ImageLogic(CreateFileMessageCommand request, Guid MyId, string fileExtensions)
        {
  ...
  MyId
        ...
        private static async Task<ChatFiles> ProcessVideo(CreateFileMessageCommand request, Guid MyId, string fileExtensions)
        {
        ...
        private static async Task<ChatFiles> ProcessAudio(CreateFileMessageCommand request, Guid MyId, string fileExtensions)
        {
        ...
        private static async Task<ChatFiles> ProcessDocument(CreateFileMessageCommand request, Guid MyId, string fileExtensions)
        {
