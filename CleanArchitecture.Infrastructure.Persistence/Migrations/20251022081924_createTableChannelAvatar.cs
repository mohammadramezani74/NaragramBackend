...
{
    /// <inheritdoc />
    public partial class createTableChannelAvatar : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_ChannelAvatars", x => x.Id);
            //    });
            migrationBuilder.Sql(
           "Create Table [dbo].[ChannelAvatars] (" +
           ...
           "CONSTRAINT[PK_ChannelAvatars] PRIMARY KEY CLUSTERED(" +
           "[Id] ASC" +
